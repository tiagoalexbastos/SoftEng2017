...
@ManagedBean(name="connectJPA")
@ApplicationScoped
public class ConnectionBrokerJPA extends HttpServlet implements Serializable{
    
    private int status = 0;
    private LinkedList<String> bigBaite;
    private List<Reading> readings;
    
    final static Logger logger = Logger.getLogger(ConnectionBrokerJPA.class);
